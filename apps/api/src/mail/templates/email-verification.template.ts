  ...
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 580px; background-color: #0B132B; margin: 40px auto; border-radius: 16px; box-shadow: 0 8px 32px rgba(0,210,255,0.08);">
    ...
    <tr>
      <td style="padding: 0 30px 20px; text-align: center;">
        <h1 style="font-size: 24px; font-weight: 700; color: #FFFFFF; margin: 0 0 12px;">Verify your email address</h1>
        <p style="font-size: 16px; line-height: 1.6; color: #D1D5DB; margin: 12px 0 24px; max-width: 480px; margin-left: auto; margin-right: auto;">
          You're so close to starting your ${appName} journey. To finish signing up, just click the button below to confirm your email address. The link will be valid for the next ${expiryMinutes} minutes.
        </p>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding: 0 30px 30px; text-align: center;">
        <a href="${verificationUrl}" target="_blank" style="display: inline-block; padding: 14px 40px; font-size: 16px; font-weight: 600; color: #0B132B; text-decoration: none; background-color: #00D2FF; border-radius: 30px; box-shadow: 0 4px 12px rgba(0,210,255,0.35);">Verify my email</a>
      </td>
    </tr>
